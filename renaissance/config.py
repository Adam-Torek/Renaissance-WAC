...
def eval_ref_twotower_electrasmall_wac_key_distributions_embeddings():
    exp_name = "eval_ref_twotower_electrasmall_wac_key_distributions_embeddings"
    model_type = "two-tower-wac"
    datasets = ["coco"]
    loss_names = _loss_names({"ref": 1})
    num_gpus = 1
    ...
    # HuggingFace settings
    huggingface_save_directory = "models"
    huggingface_save_name = "ajtorek/electra_deit_small_wac_value_distributions_embeddings"
    push_to_hub = True

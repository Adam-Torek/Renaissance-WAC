...
@ex.named_config
def pretrain_wac_enabled_vqa_twotower_electrasmall_deit_small():
    exp_name = "wac_enabled_vqa_twotower_electrasmall_deit_small"
    model_type = "two-tower-wac"
    datasets = ["vqa"]
    loss_names = _loss_names({"vqa": 1})
    batch_size = 128
...
@ex.named_config
def eval_ref_twotower_electrasmall_wac_key_distributions_embeddings():
    exp_name = "eval_ref_twotower_electrasmasll_wac_key_distributions_embeddings"
    model_type = "two-tower-wac"
    datasets = ["coco"]
    loss_names = _loss_names({"ref": 1})
    num_gpus = 1
    ...
    # HuggingFace settings
    huggingface_save_directory = "models"
    huggingface_save_name = "ajtorek/electra-deit-small-wac-key-distributions-embeddings"
    push_to_hub = True

@ex.named_config
def eval_ref_twotower_electrasmall_wac_query_distributions_embeddings():
    exp_name = "eval_ref_twotower_electrasmall_wac_query_distributions_embeddings"
    model_type = "two-tower-wac"
    datasets = ["coco"]
    loss_names = _loss_names({"ref": 1})
    num_gpus = 1
    ...
    # HuggingFace settings
    huggingface_save_directory = "models"
    huggingface_save_name = "ajtorek/electra-deit-small-wac-query-distributions-embeddings"
    push_to_hub = True

@ex.named_config
def eval_ref_twotower_electrasmall_wac_value_distributions_embeddings():
    exp_name = "eval_ref_twotower_electrasmall_wac_value_distributions_embeddings"
    model_type = "two-tower-wac"
    datasets = ["coco"]
    loss_names = _loss_names({"ref": 1})
    num_gpus = 1
    ...
    # HuggingFace settings
    huggingface_save_directory = "models"
    huggingface_save_name = "ajtorek/electra-deit-small-wac-value-distributions-embeddings"
    push_to_hub = True
